                    ...
                    if (d.type === 'string') {
                        ...
                        if (d.condition === 'contain') {
                            rows = rows.filter((item) => {
                                var _a;
                                return (_a = this.cellValue(item, d.field)) === null || _a === void 0 ? void 0 : _a.toString().toLowerCase().includes(d.value.toLowerCase());
                            });
                        }
                            ...
                            rows = rows.filter((item) => {
                                var _a;
                                return ((_a = this.cellValue(item, d.field)) === null || _a === void 0 ? void 0 : _a.toString().toLowerCase()) === d.value.toLowerCase();
                            });
                        }
                            ...
                            rows = rows.filter((item) => {
                                var _a;
                                return ((_a = this.cellValue(item, d.field)) === null || _a === void 0 ? void 0 : _a.toString().toLowerCase().indexOf(d.value.toLowerCase())) === 0;
                            });
                        }
                        else if (d.condition === 'end_with') {
                            rows = rows.filter((item) => {
                                var _a;
                                return (((_a = this.cellValue(item, d.field)) === null || _a === void 0 ? void 0 : _a.toString().toLowerCase().substr(d.value.length * -1)) === d.value.toLowerCase());
                            });
                        }
                    }
                    // number filters
