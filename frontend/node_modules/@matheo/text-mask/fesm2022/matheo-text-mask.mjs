...
function adjustCaretPosition({ previousConformedValue = '', previousPlaceholder = '', currentCaretPosition = 0, conformedValue, rawValue, placeholderChar, placeholder, indexesOfPipedChars = [], caretTrapIndexes = [] }) {
...
//# sourceMappingURL=matheo-text-mask.mjs.map
